                ...
                <div class="card">
                    <div class="card-body p-3">
                        <div class="row">
                            <div class="col-8">
                                <div class="numbers">
                                    <p class="text-sm mb-0 text-uppercase font-weight-bold">Has max follow</p>
                                    <h5 class="font-weight-bolder">
                                        {{ number_format($activeMaxFollow) }}
                                    </h5>
                                    <p class="mb-0">
                ...
                <div class="card">
                    <div class="card-body p-3">
                        <div class="row">
                            <div class="col-8">
                                <div class="numbers">
                                    <p class="text-sm mb-0 text-uppercase font-weight-bold">Feature lock</p>
                                    <div class="d-flex flex-column">
                                        <span class="font-weight-bolder">
                                            Follow: {{ number_format($locks['follow']) }}
                                        </span>
                                        <span class="font-weight-bolder">
                                            Like: {{ number_format($locks['like']) }}
                                        </span>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="card">
                    <div class="card-body p-3">
                        <div class="row">
                            <div class="col-8">
                                <div class="numbers">
                                    <p class="text-sm mb-0 text-uppercase font-weight-bold">Workers 2FA</p>
                                    <div class="d-flex flex-column">
                                        <span class="font-weight-bolder">
                                            All: {{ number_format($twoFactors['all']) }}
                                        </span>
                                        <span class="font-weight-bolder">
                                            Active: {{ number_format($twoFactors['active']) }}
                                        </span>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="card ">
                    <div class="card-header pb-0 p-3">
                        <div class="d-flex justify-content-between">
                            <h6 class="mb-2">Worker count by status</h6>
                        </div>
                    </div>
